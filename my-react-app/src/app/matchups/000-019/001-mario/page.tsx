        ...
        <div className="col-sm-12">
          ...
          <h2>Counterplay</h2>
            ...
            <ul>
              ...
              <li>Aerial fireball spawns can be punished with Up Air. Demonstration: <a href="https://x.com/SirpoSpin/status/1873412831657525579" target="_blank">[link]</a></li>
          ...
          <h2>Recommended VODs</h2>
            <ul>
              ...
              <ul><li>Wisdom praises GomaKenpi's effective evasion of Can in this set, Game 2 & 3 (starts at 7:40)</li></ul>
            </ul>
          <hr/>
